...
import { createGame,getGameDetails,addMove,getMoves,getGamesByUser,endGame } from '../controllers/Game.controller.js'
...
gameRouter.post('/:gameId/end', verifyJWT, endGame);
